...
- [API Метрик](API_METRICS.md) - Сбор и анализ системных метрик
- [API Классификации](API_CLASSIFY.md) - Классификация процессов и приложений
- [API Политики](API_POLICY.md) - Управление политиками QoS и приоритетами
- [API Безопасности](API_SECURITY.md) - Мониторинг безопасности и обнаружение угроз
- [API Конфигурации](API_CONFIG_SCHEMA.md) - Управление конфигурацией демона
