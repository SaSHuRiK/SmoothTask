...
| Class            | nice | latency_nice | ionice class/level | cpu.weight | Описание                         |
| ---------------- | ---- | ------------ | ------------------ | ---------: | -------------------------------- |
| CRIT_INTERACTIVE | -8   | -15          | 2 / 0              |        200 | фокус + аудио/игра               |
| INTERACTIVE      | -4   | -10          | 2 / 2              |        150 | обычный UI/CLI                   |
| NORMAL           | 0    | 0            | 2 / 4              |        100 | дефолт                           |
| BACKGROUND       | +5   | +10          | 2 / 6              |         50 | batch / maintenance              |
| IDLE             | +10  | +15          | 3 / 0 (idle)       |         25 | всё, что можно делать «на остатке» |
