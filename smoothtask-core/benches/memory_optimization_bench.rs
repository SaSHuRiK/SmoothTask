...
use smoothtask_core::metrics::system::{SystemMetrics, NetworkInterface, DiskDevice, CpuTimes, MemoryInfo, LoadAvg, TemperatureMetrics, PowerMetrics};
...
fn benchmark_memory_size(_c: &mut Criterion) {
    ...
    println!("Memory reduction: {} bytes ({:.2}%)", 
