...
fn test_thunderbolt_device_metrics_structures() {
    ...
    assert_eq!(
        ...
        Some(DeviceClassification::ThunderboltDevice)
    );
    assert_eq!(
        device.performance_category,
        Some(PerformanceCategory::Normal)
    );
...
fn test_thunderbolt_performance_category() {
    ...
    let high_power_category =
        manager.determine_thunderbolt_performance_category(&high_power_device);
...
fn test_thunderbolt_device_with_classification() {
    ...
    assert_eq!(
        device_with_class.device_classification,
        DeviceClassification::ThunderboltDevice
    );
    assert_eq!(
        device_with_class.performance_category,
...
fn test_performance_category_enum() {
    ...
    assert_eq!(
        PerformanceCategory::HighTemperature,
        PerformanceCategory::HighTemperature
    );
    assert_eq!(
        PerformanceCategory::HighPower,
        PerformanceCategory::HighPower
    );
    assert_eq!(
        PerformanceCategory::LowPerformance,
        PerformanceCategory::LowPerformance
    );
