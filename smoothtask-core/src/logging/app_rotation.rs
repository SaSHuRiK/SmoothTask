...
mod tests {
    ...
    fn test_app_log_rotator_creation() {
        ...
        let rotator = AppLogRotator::new(&log_path, 10_485_760, 5, true, 3600);
    ...
    fn test_app_log_rotator_needs_rotation() {
        let temp_dir = TempDir::new().expect("temp dir");
        let log_path = temp_dir.path().join("app.log");
        let rotator = AppLogRotator::new(&log_path, 1000, 5, true, 0);
    ...
    fn test_app_log_rotator_rotate_log() {
        ...
        let mut rotator = AppLogRotator::new(&log_path, 100, 3, false, 0);
    ...
    fn test_app_log_rotator_rotate_log_with_compression() {
        ...
        let mut rotator = AppLogRotator::new(&log_path, 100, 3, true, 0);
    ...
    fn test_app_log_rotator_cleanup_old_logs() {
        ...
        let mut rotator = AppLogRotator::new(&log_path, 100, 2, false, 0);
    ...
    fn test_app_log_rotator_config_update() {
        ...
        let mut rotator = AppLogRotator::new(&log_path, 1000, 3, false, 0);
    ...
    fn test_app_log_rotator_error_handling() {
        ...
        let mut rotator2 = AppLogRotator::new(&non_existent_path, 100, 3, false, 0);
