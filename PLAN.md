...
- [x] ST-775: Улучшить интеграцию health monitoring с системой уведомлений
  ...
  - Критерии готовности:
    - [x] Реализовать отправку уведомлений о критических проблемах здоровья
    - [x] Добавить поддержку различных бэкендов уведомлений
    - [x] Интегрировать с существующей системой уведомлений
    - [x] Добавить тесты для нового функционала
  - Ожидаемые результаты: Автоматическое уведомление о проблемах здоровья демона
  - Статус: COMPLETED
...
- [x] ST-776: Добавить поддержку мониторинга температуры и энергопотребления GPU
  ...
  - Критерии готовности:
    - [x] Исследовать доступные источники данных для температуры GPU
    - [x] Реализовать сбор метрик температуры и энергопотребления
    - [x] Интегрировать с существующей системой метрик GPU
    - [x] Добавить тесты для нового функционала
  - Ожидаемые результаты: Более полный мониторинг состояния GPU
  - Статус: COMPLETED
  - Время выполнения: ~60 минут
  - Результаты:
