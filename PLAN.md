...
- [ ] ST-220: Добавить endpoint /api/config для просмотра текущей конфигурации (без секретов)
  - Тип: Rust / core / api
  - Критерии готовности:
    - Endpoint возвращает текущую конфигурацию демона (без чувствительных данных);
