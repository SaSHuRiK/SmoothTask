...
- [ ] ST-057: Добавление тестов для edge cases в валидации конфигурации
  - Тип: Rust / core / config / tests
  - Критерии готовности:
    - Добавлены тесты для различных edge cases в валидации конфигурации;
    - Покрыты граничные случаи и ошибки валидации.
  - Примечания: частично выполнено - добавлены тесты для валидации прав доступа (ST-055, ST-056). Можно добавить дополнительные тесты для других edge cases.
