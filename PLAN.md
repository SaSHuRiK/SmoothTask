...
- [ ] ST-089: Добавление интеграционных тестов для collect_snapshot (покрытие edge cases)
  - Тип: Rust / core / tests
  - Критерии готовности:
    - [ ] Добавлены тесты для проверки обработки ошибок компонентов;
    - [ ] Тесты проверяют graceful fallback при недоступности компонентов;
    - [ ] Тесты проверяют корректность построения GlobalMetrics и ResponsivenessMetrics;
