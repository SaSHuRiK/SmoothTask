...
- [ ] ST-315: Добавить smoke-тесты load_snapshots_as_frame для пустых таблиц
  - Тип: Python / trainer / tests
  - Критерии готовности:
    - Проверен возврат пустого DataFrame при пустых таблицах/отсутствии строк;
    - Булевы столбцы конвертируются без предупреждений;
    - Добавлены тесты и прогнан `uv run pytest smoothtask-trainer/tests`.
