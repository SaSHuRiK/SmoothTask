...
- [ ] ST-866: Добавить поддержку мониторинга дополнительных контейнерных метрик
  ...
  - Критерии готовности:
    - [ ] Исследовать дополнительные контейнерные метрики (сетевые, дисковые, процессорные)
    - [ ] Добавить поддержку мониторинга сетевых метрик контейнеров
    - [ ] Добавить поддержку мониторинга дисковых метрик контейнеров
    - [ ] Улучшить интеграцию с существующей системой мониторинга
    - [ ] Добавить unit и integration тесты для новых функций
  - Ожидаемые результаты: Более полный мониторинг контейнерных сред с расширенными метриками
