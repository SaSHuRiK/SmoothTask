...
- [x] ST-750c: Реализовать базовый сбор метрик энергопотребления процессов
  ...
  - Критерии готовности:
    - [x] Исследовать доступные источники данных
    - [x] Реализовать функцию collect_process_energy_metrics
    - [x] Интегрировать с существующим сбором метрик процессов
    - [x] Добавить обработку ошибок и логирование
    - [x] Добавить тесты для нового функционала
    - [x] Обновить тестовые данные в ranker модуле
  - Ожидаемые результаты: Базовый мониторинг энергопотребления на уровне процессов
  - Результаты: 
    - Реализована функция collect_process_energy_metrics для сбора энергопотребления
    - Интеграция с collect_single_process для автоматического сбора энергетических метрик
    - Добавлены тесты для проверки функциональности
    - Обновлены все тестовые данные в ranker модуле с новыми полями энергопотребления
  - Изменённые файлы:
