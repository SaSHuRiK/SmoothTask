...
- [ ] ST-155: Проверка и улучшение документации для select_focused_window и pick_best_by_confidence
  - Тип: Rust / core / metrics / documentation
  - Критерии готовности:
    - Добавлена подробная документация с примерами использования;
    - Описаны граничные случаи;
    - Все doctest'ы проходят успешно.
