...
- [x] ST-297: Обновить PLAN.md: добавить новые простые задачи в Next Up
  - Тип: Документация / планирование
  - Примечания: добавлены задачи ST-298 и ST-299, структура Next Up обновлена.

- [x] ST-298: Выровнять обработку пустых тегов в trainer.features
  - Тип: Python / trainer / features
  - Примечания: `_prepare_tags_column` возвращает `"unknown"` для пустых коллекций, логика сортировки и обработки непустых тегов сохранена. Добавлены тесты.

- [x] ST-299: Добавить тесты для tags в build_feature_matrix
  - Тип: Python / trainer / tests
  - Примечания: добавлен тест на пустые коллекции, set и tuple; проверена детерминированность `tags_joined` и корректность `cat_feature_indices`.
