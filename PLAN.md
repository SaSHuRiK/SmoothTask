...
- [x] ST-801: Реализовать расширенный мониторинг температуры CPU с поддержкой нескольких источников
  ...
  - Критерии готовности:
    - [x] Исследовать доступные источники данных для температуры CPU
    - [x] Реализовать сбор метрик температуры с поддержкой нескольких сенсоров
...
- [x] ST-802: Улучшить систему кэширования метрик процессов для уменьшения накладных расходов
  ...
  - Оценка времени: ~60 минут
  - Критерии готовности:
    - [x] Проанализировать текущее использование кэша
    - [x] Реализовать более интеллектуальную стратегию кэширования
    - [x] Добавить настройку времени жизни кэша
    - [x] Добавить тесты для проверки производительности
...
- [x] ST-803: Добавить поддержку мониторинга использования памяти GPU
  ...
  - Оценка времени: ~60 минут
  - Критерии готовности:
    - [x] Исследовать доступные источники данных для памяти GPU
    - [x] Реализовать сбор метрик использования памяти GPU
    - [x] Интегрировать с существующей системой мониторинга GPU
    - [x] Добавить тесты для нового функционала
