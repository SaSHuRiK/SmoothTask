...
- [ ] ST-610: Обновить API для поддержки новой конфигурации кэширования процессов
  - Тип: Rust / core / api
  - Примечания: Добавление API endpoint'ов для управления кэшем процессов и мониторинга его состояния
  - Приоритет: Средний
  - Оценка времени: ~60 минут
  - Критерии готовности:
    - Новые API endpoint'ы для получения статистики кэша
    - Endpoint для очистки кэша
    - Endpoint для обновления конфигурации кэша
    - Интеграционные тесты для новых API
