...
- [ ] ST-760: Улучшить обработку ошибок в системе мониторинга процессов
  ...
  - Критерии готовности:
    - [ ] Проанализировать текущие сообщения об ошибках в process.rs
    - [ ] Улучшить обработку ошибок при чтении /proc данных
    - [ ] Добавить более информативные сообщения об ошибках
    - [ ] Улучшить обработку случаев отсутствия доступа к процессам
