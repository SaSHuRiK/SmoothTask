...
- [ ] ST-357: Улучшить обработку ошибок в метриках с более информативными сообщениями
...
- [ ] ST-358: Добавить документацию по использованию train_ranker в README trainer
