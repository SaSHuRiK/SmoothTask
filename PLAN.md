...
- [ ] ST-091: Улучшение документации для EvdevInputTracker с примерами использования
  - Тип: Rust / core / metrics / documentation
  - Критерии готовности:
    - [ ] Добавлена подробная документация для EvdevInputTracker с описанием методов;
    - [ ] Добавлены примеры использования;
    - [ ] Добавлено описание обработки ошибок;
    - [ ] Все существующие тесты проходят.

- [ ] ST-092: Добавление unit-тестов для InputTracker enum (проверка методов update и metrics)
  - Тип: Rust / core / metrics / tests
  - Критерии готовности:
    - [ ] Добавлены тесты для InputTracker::new() (выбор между Evdev и Simple);
    - [ ] Добавлены тесты для InputTracker::update() и InputTracker::metrics();
    - [ ] Тесты покрывают оба варианта enum (Evdev и Simple);
