...
- [x] ST-432: Реализовать расширенный мониторинг GPU метрик
  ...
  - Критерии готовности:
    - ✅ Реализовать сбор метрик GPU через DRM, sysfs и hwmon интерфейсы
    - ✅ Добавить мониторинг использования GPU, памяти, температуры и энергопотребления
    - ✅ Улучшить текущую реализацию с более точным определением GPU устройств
    - ✅ Добавить поддержку нескольких GPU устройств
    - ✅ Интегрировать GPU метрики в общую систему метрик
    - ✅ Добавить comprehensive unit-тесты для новых функций
