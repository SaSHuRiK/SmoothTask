...
- [ ] ST-217: Интеграция API сервера в run_daemon
  - Тип: Rust / core / api
  - Критерии готовности:
    - API сервер запускается вместе с демоном;
    - Данные (SystemMetrics, процессы, AppGroup) обновляются в ApiState при каждой итерации;
    - API сервер корректно останавливается при завершении демона;
    - Добавлены тесты для проверки интеграции.

- [ ] ST-218: Документация API
  - Тип: Documentation
  - Критерии готовности:
    - Добавлена документация по всем endpoints;
