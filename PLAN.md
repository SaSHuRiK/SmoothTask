...
- [ ] ST-206: Реализовать включение Snapshot Logger через конфиг (Logging Mode)
  - Тип: Rust / core / logging
  - Критерии готовности:
    - Добавлен флаг enable_snapshot_logging в конфиг;
    - Snapshot Logger включается только если флаг установлен и путь указан;
    - Добавлены unit-тесты для проверки включения/выключения логирования.
...
- [ ] ST-207: Добавить интеграцию с systemd для автозапуска
  - Тип: Rust / systemd
  - Критерии готовности:
    - Создан systemd unit файл для smoothtaskd;
    - Добавлена поддержка systemd notify;
    - Добавлена документация по установке и настройке.
