...
- [~] ST-150: Коммит форматирования кода в classes.rs (cargo fmt)
  - Тип: Rust / core / code quality
  - Критерии готовности:
    - [x] Код отформатирован через cargo fmt;
    - [ ] Изменения закоммичены.
  - Примечания: код в classes.rs уже отформатирован, нужно закоммитить изменения.

- [ ] ST-151: Проверка и улучшение документации для модулей без документации
  - Тип: Rust / core / documentation
  - Критерии готовности:
    - Определены модули/функции без документации;
    - Добавлена документация с примерами использования;
    - Все существующие тесты проходят.

- [ ] ST-152: Добавление edge case тестов для функций без тестов
  - Тип: Rust / core / tests
  - Критерии готовности:
    - Определены функции без edge case тестов;
