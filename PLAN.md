...
- [ ] ST-114: Проверка и исправление предупреждений компилятора (если есть)
  ...
  - Примечания: проверены предупреждения clippy. Исправлены основные предупреждения в ST-118. Осталось ~20 предупреждений (в основном в тестах и менее критичные). Компилятор не выдаёт предупреждений. Все тесты проходят успешно.
