...
- [ ] ST-202: Добавить новые задачи из бэклога или ROADMAP
  - Тип: Planning
  - Критерии готовности:
    - Определены новые приоритетные задачи;
    - Задачи добавлены в Next Up;
    - Задачи имеют чёткие критерии готовности.
