...
- [ ] ST-182: Проверка на наличие функций без тестов или с недостаточным покрытием
  - Тип: Rust / core / tests
  - Критерии готовности:
...
- [ ] ST-183: Проверка и улучшение документации для функций без документации (если есть)
  - Тип: Rust / core / documentation
  - Критерии готовности:
    - Определены функции без документации;
    - Добавлена документация для выявленных функций;
