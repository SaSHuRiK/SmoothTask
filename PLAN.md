...
- [x] ST-457: Исправить тесты API сервера после добавления поля model в конфигурацию
  - Тип: Rust / core / tests
  - Критерии готовности:
    - ✅ Добавить поле model во все тестовые конфигурации в API сервере
    - ✅ Убедиться, что все тесты компилируются без ошибок
    - ✅ Запустить тесты и убедиться, что они проходят
  - Примечания: После добавления ModelConfig в основную конфигурацию, все тесты нужно обновить
  - Приоритет: Высокий
  - Статус: Завершено
