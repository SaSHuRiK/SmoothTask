...
- [ ] ST-617: Добавить поддержку мониторинга температуры CPU через eBPF
  ...
  - Критерии готовности:
    ...
    - Новый API endpoint /api/cpu/temperature
    - Комплексные тесты для нового функционала
    - Документация API

- [ ] ST-618: Улучшить обработку ошибок в системных метриках
  - Тип: Rust / core / metrics
  - Примечания: Добавление более детальных сообщений об ошибках и улучшение graceful degradation для системных метрик
  - Приоритет: Средний
