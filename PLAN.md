...
- [ ] ST-268: Проверить документацию на актуальность и полноту
  - Тип: Документация
  - Критерии готовности:
    - Проверена документация в коде (doc comments);
    - Проверена документация в docs/;
    - Обновлена устаревшая документация;
