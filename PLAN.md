...
- [ ] ST-589: Исправить предупреждения компилятора об неиспользуемых импортах
  ...
  - Изменённые файлы:
    - smoothtask-core/src/api/server.rs: Исправлены неиспользуемые импорты в 8 тестовых функциях
  - Результаты: Устранены предупреждения компилятора о неиспользуемых импортах

- [ ] ST-590: Обновить PLAN.md и добавить новые задачи
...
- [ ] ST-591: Проверить код на наличие других простых улучшений
  - Тип: Rust / core / code quality
  ...
  - Изменённые файлы:
    - Различные модули: Исправления простых проблем кода
  - Результаты: Улучшение качества кода и устранение предупреждений
