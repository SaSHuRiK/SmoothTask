...
- [x] ST-571: Заменить placeholder реализации на реальный сбор данных
  - Тип: Rust / core / metrics / eBPF
  - Критерии готовности:
    - [x] Реализовать реальный сбор данных для всех оставшихся placeholder методов
    - [x] Убедиться, что все методы используют iterate_ebpf_map_keys для полной итерации
    - [x] Обновить тесты для проверки реальных данных
...
- [x] ST-572: Улучшить документацию и комментарии в eBPF модуле
  - Тип: Rust / core / metrics / eBPF
  - Критерии готовности:
    - [x] Обновить документацию модуля
    - [x] Добавить комментарии для сложных алгоритмов
    - [x] Улучшить документацию публичных методов
