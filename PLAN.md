...
- [x] ST-130: Добавление документации для модуля model/mod.rs
  ...
  - Критерии готовности:
    - [x] Добавлена подробная документация модуля с описанием компонентов;
    - [x] Добавлены примеры использования для построения фич и ранжирования;
    - [x] Добавлено описание будущих улучшений;
    - [x] Все существующие тесты проходят (9 тестов в модуле model).
  - Примечания: добавлена подробная документация для модуля model/mod.rs с описанием компонентов (features, ranker), примерами использования для построения фич и ранжирования групп, и описанием будущих улучшений (интеграция с ONNX Runtime, поддержка JSON-формата моделей, кэширование фич). Все 9 тестов в модуле model проходят успешно.

- [x] ST-131: Улучшение документации для RankingResult структуры
  - Тип: Rust / core / model / documentation
  - Критерии готовности:
    - [x] Добавлена подробная документация структуры с описанием полей;
    - [x] Добавлены примеры использования RankingResult;
    - [x] Добавлено описание различий между score и percentile;
    - [x] Все существующие тесты проходят (9 тестов в модуле model).
  - Примечания: улучшена документация для структуры RankingResult с подробным описанием полей (score, rank, percentile), примерами использования для определения приоритета групп, описанием различий между score и percentile, и формулой вычисления percentile. Все 9 тестов в модуле model проходят успешно.
