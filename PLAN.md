...
- [x] ST-454: Интеграция ONNX Runtime для инференса в Rust
  - Тип: Rust / core / ml
  - Критерии готовности:
    - ✅ Добавить зависимость ort в Cargo.toml
    - ✅ Реализовать загрузку и выполнение ONNX модели в Rust
    - ✅ Создать ONNXRanker структуру, реализующую Ranker trait
    - ✅ Написать unit-тесты для ONNX интеграции
    - ⏳ Интегрировать инференс в Policy Engine (будет сделано в следующей задаче)
  - Примечания: Реализована базовая интеграция ONNX Runtime для загрузки и выполнения CatBoost моделей
  - Приоритет: Высокий
  - Статус: Частично завершено (основная функциональность реализована)

- [ ] ST-456: Интеграция ONNXRanker в Policy Engine
  - Тип: Rust / core / policy
  - Критерии готовности:
    - Добавить поддержку ONNXRanker в Policy Engine
    - Реализовать загрузку модели из конфигурации
    - Добавить fallback на StubRanker при отсутствии модели
    - Написать интеграционные тесты для Policy Engine с ONNX
  - Примечания: Необходимо для использования ML-моделей в реальном ранжировании
  - Приоритет: Высокий
  - Блокер: ST-454 (нужна реализация ONNXRanker)
