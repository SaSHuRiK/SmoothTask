...
- [ ] ST-114: Проверка и исправление предупреждений компилятора (если есть)
  - Тип: Rust / core / code quality
  - Критерии готовности:
    - Проверены все предупреждения компилятора;
    - Исправлены все предупреждения (или добавлены allow атрибуты, если необходимо);
    - Все тесты проходят без предупреждений.
  - Примечания: проверены предупреждения clippy (есть несколько предупреждений, но они не критичны). Компилятор не выдаёт предупреждений. Все тесты проходят успешно.

- [ ] ST-116: Улучшение документации для функций без документации
  - Тип: Rust / core / documentation
  - Критерии готовности:
    - Определены функции без документации;
