...
- [ ] ST-163: Проверка на наличие простых улучшений кода (если есть)
  - Тип: Rust / core / code quality
  - Критерии готовности:
    - Проверены все модули на наличие простых улучшений;
    - Выявлены и устранены простые проблемы (если есть);
    - Все тесты проходят успешно.

- [ ] ST-164: Проверка на наличие простых тестов, которые можно добавить
  - Тип: Rust / core / tests
  - Критерии готовности:
    - Определены функции без тестов или с недостаточным покрытием;
    - Добавлены простые тесты для выявленных функций;
    - Все тесты проходят успешно.
