...
- [ ] ST-166: Проверить и улучшить документацию для вспомогательных функций в config.rs
  - Тип: Rust / core / documentation
  - Критерии готовности:
    - Проверены все вспомогательные функции (default_policy_mode, default_sched_latency_p99_threshold, default_ui_loop_p95_threshold);
    - Добавлена документация с описанием назначения и примеров использования;
    - Все существующие тесты проходят.

- [ ] ST-167: Добавить тесты для проверки консистентности дефолтных значений конфигурации
  - Тип: Rust / core / tests
  - Критерии готовности:
    - Добавлены тесты, проверяющие, что дефолтные значения соответствуют ожидаемым;
    - Тесты проверяют консистентность между дефолтами и валидацией;
