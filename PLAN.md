...
- [x] ST-424: Реализовать продвинутую систему логирования с ротацией логов
  - Тип: Rust / core / logging
  - Примечания: Улучшение системы логирования для долговременного использования в production.
  - Результаты:
    - Добавлена структура LoggingConfig с параметрами ротации и сжатия
    - Реализован модуль logging::rotation с функциональностью LogRotator
    - Добавлены методы для ротации по размеру, времени и сжатия логов
    - Обновлен SnapshotLogger для поддержки новой функциональности
