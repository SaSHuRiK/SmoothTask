...
- [ ] ST-158: Проверка кода на наличие других простых улучшений (неиспользуемые импорты, дублирование кода)
  - Тип: Rust / core / code quality
  - Критерии готовности:
    - Проверены все модули на неиспользуемые импорты;
    - Выявлено и устранено дублирование кода (если есть);
    - Код проходит clippy без предупреждений.
