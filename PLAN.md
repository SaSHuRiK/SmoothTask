...
- [x] ST-771: Улучшить систему автоматического обнаружения приложений
  ...
  - Критерии готовности:
    - [x] Улучшить эвристики обнаружения приложений
    - [x] Добавить поддержку обнаружения по исполняемым файлам и аргументам
    - [x] Улучшить обработку сложных случаев (контейнеры, sandbox)
    - [x] Добавить тесты для новых алгоритмов обнаружения
