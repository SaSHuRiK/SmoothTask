...
- [x] ST-535: Добавить документацию для новых eBPF функций и улучшений
  - Тип: Rust / core / metrics / eBPF / documentation
  - Критерии готовности:
    - [x] Обновить EBPF_SETUP.md с информацией о новых функциях
    - [x] Добавить примеры использования расширенного мониторинга системных вызовов
    - [x] Документировать новые параметры конфигурации
    - [x] Добавить раздел по устранению неполадок для сетевого мониторинга
    - [x] Создать примеры интеграции с основной системой метрик
  - Примечания: Успешное обновление документации для новых eBPF функций
  - Приоритет: Высокий
  - Оценка времени: ~60 минут
  - Статус: COMPLETED
  - Время выполнения: ~60 минут
  - Изменённые файлы:
    - docs/EBPF_SETUP.md: Значительно расширена документация с добавлением новых разделов
  - Новые возможности:
    - Документация по расширенному мониторингу системных вызовов
    - Документация по мониторингу сетевой активности
    - Примеры интеграции с основной системой метрик
    - Расширенные разделы по устранению неполадок
    - Примеры использования новых eBPF программ

- [x] ST-536: Реализовать реальную загрузку и выполнение eBPF программ
  - Тип: Rust / core / metrics / eBPF / implementation
  - Критерии готовности:
    - [x] Заменить заглушки на реальную загрузку eBPF программ
    - [x] Интегрировать libbpf-rs для управления eBPF программами
    - [x] Реализовать сбор метрик из eBPF карт
    - [x] Добавить обработку ошибок для реальных eBPF операций
    - [x] Обновить тесты для работы с реальными eBPF программами
...
- [x] ST-537: Добавить интеграционные тесты с реальными eBPF программами
  ...
  - Критерии готовности:
    - [x] Создать тесты для реальной загрузки eBPF программ
    - [x] Добавить тесты для сбора метрик из eBPF
    - [x] Проверить совместимость с различными версиями ядра
    - [x] Добавить тесты для обработки ошибок
    - [x] Интегрировать с CI/CD пайплайном
