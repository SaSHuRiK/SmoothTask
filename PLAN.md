...
- [ ] ST-160: Проверка и улучшение документации для функций без документации (если есть)
...
- [ ] ST-161: Проверка и улучшение обработки ошибок (если есть места для улучшения)
  - Тип: Rust / core / error handling
  - Критерии готовности:
    - Определены места с неоптимальной обработкой ошибок;
