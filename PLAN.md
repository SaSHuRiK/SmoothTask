...
- [x] ST-592: Исправить ошибки компиляции в ebpf_mock_test.rs
  ...
  - Зависимости: Текущее состояние кода
  - Статус: COMPLETED
  - Время выполнения: ~10 минут
  - Изменённые файлы:
    - smoothtask-core/tests/ebpf_mock_test.rs: Добавлены поля gpu_compute_units, gpu_power_usage, gpu_temperature, cpu_temperature, cpu_max_temperature, cpu_temperature_details в 2 тестовых структурах
...
- [x] ST-593: Исправить предупреждения clippy в ebpf.rs
  ...
  - Изменённые файлы:
    - smoothtask-core/src/metrics/ebpf.rs: Удалены неиспользуемые импорты Notification и NotificationType, исправлены 2 случая unnecessary mut в тестах
...
- [x] ST-594: Обновить PLAN.md с текущим статусом
  ...
  - Примечания: Обновление PLAN.md для отражения выполненных задач и текущего состояния
  - Приоритет: Средний
  - Оценка времени: ~15 минут
  - Зависимости: ST-592, ST-593
  - Статус: COMPLETED
  - Время выполнения: ~10 минут
  - Изменённые файлы:
    - PLAN.md: Обновлен статус задач, добавлены новые выполненные задачи
