...
- [x] ST-477: Добавить поддержку мониторинга сетевых метрик
  - Тип: Rust / core / metrics
  - Примечания: Реализован сбор сетевых метрик (трафик, ошибки) из /proc/net/dev. Добавлены интеграционные тесты для API, тесты парсинга с реальными данными. Обновлена документация METRICS.md с описанием структуры данных и примеров. Сетевые метрики включают информацию о интерфейсах (rx_bytes, tx_bytes, rx_packets, tx_packets, rx_errors, tx_errors) и агрегированные метрики (total_rx_bytes, total_tx_bytes).
