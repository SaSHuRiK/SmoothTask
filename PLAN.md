...
- [ ] ST-146: Проверка и улучшение документации для вспомогательных функций парсинга в audio_pipewire.rs
  - Тип: Rust / core / metrics / documentation
  - Критерии готовности:
    - Добавлена документация для parse_latency_string, parse_rate_string, parse_u32;
