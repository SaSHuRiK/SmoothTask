...
- [ ] ST-042: Выбрать и реализовать следующую маленькую задачу
  - Тип: Планирование / реализация
  - Критерии готовности:
    - Выбрана конкретная маленькая задача из бэклога или создана новая;
    - Задача реализована и покрыта тестами;
    - Обновлён PLAN.md.
