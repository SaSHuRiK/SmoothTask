...
- [x] ST-447: Реализовать API эндпоинты для управления уведомлениями
  ...
  - Результаты:
    - Добавлены три новых API эндпоинта: /api/notifications/test, /api/notifications/status, /api/notifications/config
    - Реализованы обработчики для отправки тестовых уведомлений, получения статуса и изменения конфигурации
    - Добавлены комплексные тесты для всех новых эндпоинтов (10 новых тестов)
    - Обновлена документация API.md с полным описанием новых эндпоинтов
    - Все тесты проходят успешно (57 тестов в модуле api::server::tests)
