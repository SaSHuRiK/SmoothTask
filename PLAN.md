...
- [ ] ST-210: Добавить поддержку systemd notify в демон
  - Тип: Rust / systemd
  - Критерии готовности:
    - Добавлена зависимость `libsystemd` или `systemd` crate;
    - Реализована отправка READY=1 после успешной инициализации;
    - Реализована отправка STATUS=... для обновления статуса;
    - Добавлены unit-тесты для проверки интеграции.

- [ ] ST-211: Добавить документацию по установке и настройке systemd
  - Тип: Documentation
  - Критерии готовности:
    - Создан раздел в README.md или отдельный файл `docs/INSTALLATION.md`;
    - Описаны шаги установки systemd unit файла;
    - Описаны команды для управления сервисом (enable, start, status);
    - Описана настройка конфига и путей.

## 2. Бэклог

- [ ] ST-207: Добавить интеграцию с systemd для автозапуска
  - Тип: Rust / systemd
  - Статус: частично выполнено (ST-209 создал unit файл)
  - Осталось:
    - Добавлена поддержка systemd notify (ST-210);
    - Добавлена документация по установке и настройке (ST-211).
