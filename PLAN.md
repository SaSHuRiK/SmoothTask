...
- [ ] ST-749: Улучшить обработку ошибок в системе логирования
  ...
  - Критерии готовности:
    ...
    - [ ] Улучшить сообщения об ошибках в ключевых модулях
    - [ ] Добавить контекстную информацию к ошибкам
    - [ ] Добавить тесты для новых сообщений об ошибках
  - Ожидаемые результаты: Более информативные и полезные сообщения об ошибках
