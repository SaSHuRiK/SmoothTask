...
- [ ] ST-106: Улучшение документации для ResponsivenessMetrics::compute() с более подробными примерами использования
  - Тип: Rust / core / logging / documentation
  - Критерии готовности:
    - Добавлена подробная документация с описанием алгоритма вычисления bad_responsiveness и responsiveness_score;
    - Добавлены примеры использования функции;
    - Добавлено описание весов метрик и нормализации;
    - Все существующие тесты проходят.

- [ ] ST-107: Добавление валидации для проверки, что period_end >= period_start в AudioMetrics
  - Тип: Rust / core / metrics / validation
  - Критерии готовности:
    - Добавлена проверка валидности периода (period_end >= period_start);
    - Добавлены unit-тесты для проверки валидации;
    - Все существующие тесты проходят.
